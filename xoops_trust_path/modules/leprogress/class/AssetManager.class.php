...
/**
 * Leprogress_AssetManager
**/
class Leprogress_AssetManager
{
    public /*** string ***/ $mDirname = '';

    public /*** string ***/ $mTrustDirname = 'leprogress';
    ...
    **/
     ...
     * @param   string  $dirname
     * 
     * @return  Leprogress_AssetManager
    **/
    public function &getInstance(/*** string ***/ $dirname)
    {
        /**
         *  @var    Leprogress_AssetManager[]
        **/
    ...
    **/
    ...
    {
        return LEPROGRESS_TRUST_PATH . ($isAdmin ? '/admin/' : '/');
    }
}
