...
define('LEPROGRESS_ITEM_SORT_KEY_TITLE', 2);
define('LEPROGRESS_ITEM_SORT_KEY_DIRNAME', 3);
define('LEPROGRESS_ITEM_SORT_KEY_DATANAME', 4);
define('LEPROGRESS_ITEM_SORT_KEY_TARGET_ID', 5);
define('LEPROGRESS_ITEM_SORT_KEY_UID', 6);
define('LEPROGRESS_ITEM_SORT_KEY_STEP', 7);
define('LEPROGRESS_ITEM_SORT_KEY_STATUS', 8);
define('LEPROGRESS_ITEM_SORT_KEY_POSTTIME', 9);
define('LEPROGRESS_ITEM_SORT_KEY_DELETETIME', 10);
define('LEPROGRESS_ITEM_SORT_KEY_DEFAULT', LEPROGRESS_ITEM_SORT_KEY_ITEM_ID);

/**
 * Leprogress_ItemFilterForm
**/
class Leprogress_ItemFilterForm extends Leprogress_AbstractFilterForm
{
    public /*** string[] ***/ $mSortKeys = array(
        LEPROGRESS_ITEM_SORT_KEY_ITEM_ID => 'item_id',
        LEPROGRESS_ITEM_SORT_KEY_TITLE => 'title',
    ...
    **/
    ...
    {
        return LEPROGRESS_ITEM_SORT_KEY_DEFAULT;
    }
